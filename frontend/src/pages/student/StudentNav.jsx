      ...
      {/*   className="offcanvas offcanvas-start text-white"
        ...
        <div className="offcanvas-body back-color text-white ">
          ...
          <div className="cart">
            ...
            />
            <label className="years">&nbsp;50-25</label> <br />
            <input
              type="radio"
              className="input"
              name="amount"
          ...
          <div className="cart">
            <h2>CLUBS</h2> 
            <input type="radio" className="input" name="amount" value="Chess Club"
            ...
            <input
              ...
              name="clubs"
              value="Sport Club"
              onChange={() => handleCheckboxChange("clubs", "Others")}
            />
            <label className="years">&nbsp;Others</label> <br />
          </div>
          <div className="cart">     
            <h2>OTHERS</h2>
            <input
